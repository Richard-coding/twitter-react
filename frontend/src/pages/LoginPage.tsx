...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 py-8"
      ...
      <div className="flex w-full max-w-3xl min-h-[500px] rounded-3xl overflow-hidden"
        ...
        <div className="hidden sm:flex flex-col justify-end p-10 w-72 flex-shrink-0 relative overflow-hidden"
        ...
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 py-10">
          ...
          <h1 className="text-2xl font-bold text-slate-100 mb-1 tracking-tight">Entrar na sua conta</h1>
          <p className="text-sm text-slate-500 mb-8">Acesse o Pananbook com seu e-mail e senha.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                onFocus={(e) => { e.currentTarget.style.border = "1px solid #7c3aed"; e.currentTarget.style.background = "rgba(124,58,237,0.08)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(124,58,237,0.18)"; }}
                onBlur={(e) => { e.currentTarget.style.border = "1px solid rgba(255,255,255,0.1)"; e.currentTarget.style.background = "rgba(255,255,255,0.06)"; e.currentTarget.style.boxShadow = "none"; }}
              />
            </div>
